          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card" style="margin-bottom: 300px">
                <div class="card-body">
                  <div class="pt-2 pb-1">
                    <h5 class="card-title text-center pb-0 fs-4">초기 비밀번호 부여</h5>
                  </div>

                  <form class="row g-3 needs-validation" novalidate>
                    <div class="col-12 pb-3">
                      <label for="yourPassword" class="form-label">부여할 사원 ID</label>
                      <div class="input-group has-validation">
                        <input type="password" name="password" class="form-control" placeholder="비밀번호 입력" required>
                        <div class="invalid-feedback">사원 ID를 입력해주세요.</div>
                      </div>
                    </div>
                    
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">초기 비밀번호</label>
                      <input type="password" name="password" class="form-control" placeholder="비밀번호 재입력" id="yourPassword" required>
                      <div class="invalid-feedback">초기 비밀번호를 입력해주세요.</div>
                    </div>

                    <div class="col-12 pb-3">
                      <label for="yourPassword" class="form-label">비밀번호 확인</label>
                      <input type="password" name="password" class="form-control" placeholder="비밀번호 재입력" id="yourPassword" required>
                      <div class="invalid-feedback">초기 비밀번호를 다시 입력해주세요.</div>
                    </div>
                    <div class="col-12 pb-2 mx-auto" style="width:250px;">
                      <button class="btn btn-primary w-100" type="submit">비밀번호 부여</button>
                    </div>
                  </form>
                </div>
              </div>
