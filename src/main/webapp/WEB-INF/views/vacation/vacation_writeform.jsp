...
<%@ include file="/WEB-INF/views/common/head.jsp"%>
	...
	<script src="${pageContext.request.contextPath}/resources/assets/js/bootstrap-datepicker.ko.min.js"></script> 
	<style>
	.card-header {
						...
						<div class="card-body pt-4">
							<form class="profile-overview " method="post" id="vacation_form" action="${pageContext.request.contextPath}/vacation/write">
								...
								<div class="row ">
									...
									<div class="col-sm-6">
										<input type="radio" name="vacationType" value="1" checked="checked"> 정기휴가 <input type="radio" name="vacationType" value="2"> 경조사
									</div>
								</div>
								<!-- 휴가 종류 -->
								<div class="row ">
									...
									<div class="col-sm-4">
										<select id="POP" name="vacationCategoryId" class="form-select" aria-label="Default select example" onchange="vtype()">
								...
								<div id="dateplace">
									<div class="row">
										...
										<div class="col-sm-10 label">
											<input id="datePicker" type="text" name="dates" style="width: 100%" onchange="countDate()" class="form-control" required>
											<p id="choiceDate" class="small">선택 일수 : 0일</p>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-sm-12 d-flex justify-content-end">
										<button type="button" class="btn btn-primary" onclick="submitButton()">제출하기</button>
									</div>
								</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p style="margin-bottom: 4px">사유를 입력해 주세요.</p>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p style="margin-bottom: 4px">
							<i class="bi bi-exclamation-triangle"
								style="margin-right: 10px; color: red;"></i>연차 보유현황을 확인해주세요
						</p>
